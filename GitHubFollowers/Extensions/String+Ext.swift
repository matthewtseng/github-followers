...
extension String {
    ...
    // Refer to nsdateformatter.com to figure out dateFormat string
    func convertToDate() -> Date? {
        let dateFormatter = DateFormatter()
        dateFormatter.dateFormat = "yyyy-MM-dd'T'HH:mm:ssZ" // This is the format that User.createdAt returns
